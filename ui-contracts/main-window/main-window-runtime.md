...
| Account footer             | Log in                                         | Click                             | `Auth`                                      | Auth flow entry from `Auth` component                         | Footer enters signing-in/waiting state; browser or embedded auth opens; after success the footer shows identity/role, and account-gated actions such as Publish can continue. | `apps/electron/src/renderer/src/components/sidebar/Auth.tsx:38`; `apps/electron/src/renderer/src/components/sidebar/Auth.tsx:73`; `electron-user-journeys-hierarchy-v2/03-account-login/account-login-authentication.pm.md` |
...
| Signed out                       | `Log in` action in footer; account-required actions show login gate | No current account identity                                | Click login                                | Auth flow / signed-in footer | `apps/electron/src/renderer/src/components/sidebar/Auth.tsx:38`; `electron-user-journeys-hierarchy-v2/03-account-login/account-login-authentication.pm.md` |
...
| `MAIN-04` | Login-gated publish action  | Click Publish while signed out | Publish does not submit; user sees login requirement and returns to publish context after authentication. | `electron-user-journeys-hierarchy-v2/03-account-login/account-login-authentication.pm.md`; `electron-user-journeys-hierarchy-v2/09-catalog-review/catalog-review-publish.pm.md` | L3 planned |
