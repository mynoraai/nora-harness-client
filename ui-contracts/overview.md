...
| `code-ide/`                    | `README.md`, `code-mode-runtime.md`, `chat-code-runtime-workbench.md`, `chat-code-runtime-workbench.html`                                                                                                                                                    |
...
- `code-ide/README.md` maps `CODE-01` through `CODE-14`, with `code-mode-runtime.md` covering workspace selection, Code sessions, file/diff panels, device/terminal panels, and empty/error states, and `chat-code-runtime-workbench.md` covering Draft/Codex/Claude/OpenClaw runtime binding.
