...
**System response:** The selection persists to the exec approvals file, with rollback on failure.
**Success criteria:**
...
| Change command execution mode                   | Approval mode radio group is enabled.                      | Radio selection updates optimistically; gateway approval file is persisted; rollback on failure.                     | `exec.approvals.get` then `exec.approvals.set`.                                  | `apps/electron/src/renderer/src/components/settings/PermissionsTab.tsx:186`; `apps/electron/src/renderer/src/components/settings/PermissionsTab.tsx:205`; `apps/electron/src/renderer/src/components/settings/PermissionsTab.tsx:215`; `apps/electron/src/renderer/src/components/settings/PermissionsTab.tsx:356`                                           | No focused PermissionsTab test. |
