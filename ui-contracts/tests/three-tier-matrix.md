...
| `CODE-14`                                                                                          | Code Runtime Workbench           | No focused test   | Needs Draft/Codex/Claude/OpenClaw session matrix with runtime selector enabled only before session binding                                         |
...
| `CODE-runtime-binding`      | `CODE-14`, `BND-02`, `BND-04`                                                                      | Verify runtime binding and ACP workbench states.      | No harness |
