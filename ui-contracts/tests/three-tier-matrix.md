...
| `CODE-13`                                                                                          | Cloud deploy latent branch       | No test           | Needs explicit absence assertion while visible top tabs include Preview and still omit Cloud                                                       |
...
| `AUTH-05`                                                                                          | Unified publish center           | Partial           | Export dialog covered; publish center missing: login gate, rows, review, production package publish, firmware publish                              |
...
| `AUTH-publish-center`       | `AUTH-05`                                                                                          | Use unified publish center with controlled stubs.     | No harness |
