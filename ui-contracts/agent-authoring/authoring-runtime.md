...
| `AUTH-05` | Publish/export | Click Publish or export         | Publish to Catalog dialog shows sign-in state, package digest, mode radio, display fields, success/error/retry; export creates tarball. | Publish/export IPC/cloud calls                   | `apps/electron/src/renderer/src/components/agent-authoring/AgentAuthoringTab.tsx:221`; `apps/electron/src/renderer/src/components/agent-authoring/PublishCatalogDialog.tsx:239`; `apps/electron/src/renderer/src/components/agent-authoring/PublishCatalogDialog.tsx:283`; `apps/electron/src/renderer/src/components/agent-authoring/PublishCatalogDialog.tsx:303`; `apps/electron/src/renderer/src/components/agent-authoring/PublishCatalogDialog.tsx:468` | No L3 test |
...
```mermaid
flowchart TD
  Open["Click Publish"] --> Auth["check sign-in"]
  Auth --> Build["package agent files"]
...
| 2    | `check sign-in`                   | Dialog determines whether publishing can proceed for the current account. | User sees sign-in state or publish controls. |
