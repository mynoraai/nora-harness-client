...
This folder covers Agent Authoring in the Electron IDE. Use it when you need to understand the `Edit Agent` tab, editable agent files, skills, capabilities, secondary mobile preview behavior, Publish to Catalog, or package export behavior.
...
- Mobile Preview exists, but is secondary to the primary Agent Authoring inventory journey.
