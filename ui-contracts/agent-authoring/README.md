...
This folder covers Agent Authoring in the Electron IDE. Use it when you need to understand the `Edit Agent` tab, editable agent files, skills, capabilities, removed Mobile Preview boundary, Publish to Catalog, or package export behavior.
...
| `AUTH-04`  | [mobile-preview.md](./mobile-preview.md) | Deleted Mobile Preview entry                                            |
...
- Mobile Preview is marked as a deleted entry for the current Agent Authoring inventory.
